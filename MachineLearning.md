...
WSO2 Machine learner | Predictive analytics engine | platform, enterprise | http://wso2.com/products/machine-learner/
Pipeline AI | ML pipeline platform | platform, hosted | https://github.com/fluxcapacitor/pipeline
Oryx | Realtime ML platform using Spark and Kafka | platform, Spark, realtime | http://oryx.io/
MichaelAngelo | Uber's ML platform | platform | https://eng.uber.com/michelangelo/
Tensorflow examples | Tensor flow examples | tensorflow, examples | https://github.com/pkmital/pycadl , https://github.com/aymericdamien/TensorFlow-Examples
PlantVillage dataset | Leaves diseases labelled images | dataset, images, leaves | https://github.com/spMohanty/PlantVillage-Dataset/tree/master/raw/color
ImageNet | Image datasets | datasets, images | http://image-net.org/index
Cancer Images | Cancer image datasets | datasets, images, medical | http://www.cancerimagingarchive.net/ , https://wiki.cancerimagingarchive.net/display/Public/Wiki
GrandChallenge | Biomedical image ML challenges | datasets, images, medical | https://grand-challenge.org/
Deep Learning papers | Scientific papers on deep learning | deep learning, papers, awesome-list | https://github.com/terryum/awesome-deep-learning-papers
Facenet | Tensorflow based face recognition | face recognition | https://github.com/davidsandberg/facenet, https://github.com/zixia/node-facenet
Speech recognition | Tensorflow based speech recognition | tensorflow, speech recognition | https://github.com/zzw922cn/Automatic_Speech_Recognition , https://github.com/llSourcell/tensorflow_speech_recognition_demo
...
Game Theory Course | Stanford game theory course | game-theory, course | https://theory.stanford.edu/~tim/f13/f13.html
...
Tensorflow + Docker | Tensorflow and docker production depoyment | tensorflow, docker, devops | https://medium.com/botsupply/tensorflow-docker-production-ready-ai-product-ae30435ad8e9
...
DevOps for ML | Devops best practises for Ml projects | tutorial, devops | https://www.datasciencecentral.com/profiles/blogs/devops-pipeline-for-a-machine-learning-project
...
Rubik's cube convnet | Solving Rubik's cube using conv NN | convnet, rubik's-cube, tutorial | https://github.com/jerpint/rubiks_cube_convnet
Kubeflow ** | ML toolkit for kubernetes | kubernetes, google, tf | https://www.kubeflow.org/
Tensorflow object detection | Tensorflow + docker | docker, tensorflow, tutorial, object-detection | https://medium.com/@evheniybystrov/tensorflow-object-detection-with-docker-from-scratch-5e015b639b0b
...
Truthsayer | ML based lie detector and heart rate monitor | face | https://github.com/everythingishacked/Truthsayer
Whisper ** | STT model from OpenAI | stt | https://github.com/openai/whisper
